...
public class SetupMend extends Command
{
	...
	public void execute(ArrayList<String> args) 
	{
		...
		{
			System.err.println("WARNING: MEND already has a Settings.xml file at " + Config.CONFIG_PATH + Config.SETTINGS_FILE);
			setupExists = true;
		}
	...
	private void setKeysFromInputFile(String password, String privateKeyFilePath, String publicKeyFilePath) throws Exception
	{
