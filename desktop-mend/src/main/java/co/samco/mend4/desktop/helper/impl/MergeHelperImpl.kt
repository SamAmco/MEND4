...
class MergeHelperImpl @Inject constructor(
    ...
    override fun mergeToFirstOrSecond(logFiles: Pair<File, File>, first: Boolean) {
    ...
    override fun mergeLogFilesToNew(files: Pair<File, File>, outputLog: File) {
